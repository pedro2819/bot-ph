...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:Phtbs\n' // Nama kamu
            + 'ORG:Lexa;\n' // Nama bot
            + 'TEL;type=CELL;type=VOICE;waid=556899186852:+556899186852\n' //Nomor whatsapp kamu
            + 'END:VCARD'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD minatin BOT*',
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de Minatin. Registre-se para fazer amizade com o bot Minatin por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar Minatin|17\n\n──「 Minatin BOT 」──`,
			...
			const ownerNumber = ["556899186852@s.whatsapp.net","12267740582@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"556899186852@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["556899186852@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["556899186852@s.whatsapp.net"]//ubah nomor lo
			const premium = ["556899186852@s.whatsapp.net","557399469117@s.whatsapp.net","12267740582@s.whatsapp.net","559784130980@s.whatsapp.net","557599941062@s.whatsapp.net","558598669655@s.whatsapp.net","5511949051934@s.whatsapp.net","554792091566@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","554298653614@s.whatsapp.net","12267740582@s.whatsapp.net"]
...
case 'cep1':
			        ...
			        base1 = `🔎 Minaton CONSULTAS / BASE 1 🔎
...
case 'base1':
			        ...
			        base1 = `🔎 Minatin CONSULTAS / BASE 1 🔎
...
📌 BY: Minatin BOT `
			        ...
			        base2 = `🔎 Minatin CONSULTAS / BASE 2 🔎
...
📌 BY: Minatin BOT `
                ...
                case 'base3':
			        ...
			        base3 = `🔎 Minatin CONSULTAS / BASE 3 🔎
...
📌 BY: Minatin BOT `
			        ...
			        base4 = `🔎 Minatin CONSULTAS / BASE 4 🔎
...
📌 BY: Minatin BOT `
                ...
                case 'base5':
			        ...
			        base5 = `🔎 Minatin CONSULTAS / BASE 5 🔎
...
📌 BY: Minatin BOT `
                ...
                case 'base6':
			        ...
			        base6 = `🔎 Minatin CONSULTAS / BASE 6 🔎
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOO Minatin BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @minatin domina vida
			...
			break
               ...
               if (anu.error) return reply(anu.error)
                ...
                case 'ninjalogo':
                    ...
                    client.sendMessage(from, tod, image, { quoted: mek, caption: '*minatin domina ✓*'})
                    break
                    case 'animemenu':
          ...
          reply('Espere..')
				...
				if (!isUser) return reply(mess.only.userB)
					...
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*╭────*「 *PREMIUM USER👑* 」\n*│+ wa.me/5517988058041*╰──────*「 *Minatin* 」*────*\n\n*_SE QUER SER UM USUÁRIO PREMIUM DO Minatin BOT_*\n*_Ketik #daftarvip*' })
					break
					case 'cekmod': 
